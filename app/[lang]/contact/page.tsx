        ...
        <div className="bg-slate-50 min-h-screen py-16 border-t border-slate-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{dict.navigation.contact}</h1>
                    ...
                    <div className="space-y-6">
                        ...
                        <a href="tel:+995591959607" className="flex items-center p-6 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all group">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-xl font-bold text-gray-900">+995 591 959 607</p>
                            </div>
                        </a>
                        ...
                        <a href="mailto:zarqua.g1996@gmail.com" className="flex items-center p-6 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all group">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-xl font-bold text-gray-900">zarqua.g1996@gmail.com</p>
                            </div>
                        </a>
                        ...
                        <div className="flex items-center p-6 bg-white rounded-2xl shadow-sm border border-slate-200">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-xl font-bold text-gray-900">{dict.contact.address}</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200 p-8 md:p-10">
                        ...
                        <form className="space-y-6">
                            <div>
                                ...
                                <input type="text" id="name" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent outline-none transition-all" placeholder="თქვენი სახელი" />
                            </div>
                            <div>
                                <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-1">ტელეფონის ნომერი</label>
                                <input type="tel" id="phone" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent outline-none transition-all" placeholder="+995 5XX XX XX XX" />
                            </div>
                            <div>
