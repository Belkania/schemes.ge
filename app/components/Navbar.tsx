            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-20">
                    ...
                    <div className="flex items-center md:hidden">
                        <div className="flex items-center space-x-3 mr-2 bg-slate-50 border border-gray-100 rounded-full px-3 py-1">
                            <Link href={switchLanguage('ka')} className={`text-xs ${lang === 'ka' ? 'font-bold text-[var(--color-primary)]' : 'text-gray-500 hover:text-gray-700'}`}>KA</Link>
                            <Link href={switchLanguage('en')} className={`text-xs ${lang === 'en' ? 'font-bold text-[var(--color-primary)]' : 'text-gray-500 hover:text-gray-700'}`}>EN</Link>
                            <Link href={switchLanguage('ru')} className={`text-xs ${lang === 'ru' ? 'font-bold text-[var(--color-primary)]' : 'text-gray-500 hover:text-gray-700'}`}>RU</Link>
                        </div>
                        <button
